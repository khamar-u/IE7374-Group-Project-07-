...
- Umang Khamar — NLP Engineer: DistilBERT fine-tuning, spaCy NER, symptom clustering, metrics (precision/recall/F1). Deliverables: models/distilbert_prelim/ (model + tokenizer + metrics), ner_entities.json, symptom_clusters.json, classification metrics (precision/recall/F1).
